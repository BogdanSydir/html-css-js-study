...
for (let coursesElement of coursesArray) {
    ...
    outer.style.background = 'cornflowerblue'
    ...
    monthDuration.innerText = `${'duration : ' + coursesElement.monthDuration}`
    outer.appendChild(monthDuration)
    monthDuration.style.width = '40%'

    let hourDuration = document.createElement('div')
    hourDuration.innerText = `${'hour duration : ' + coursesElement.hourDuration}`
    outer.appendChild(hourDuration)
